...
(function() {
  var click_add_btn, click_delete, click_sort_btn, click_toggle_details, delete_task, high_els, highlight_column, init_add_btn, init_all, init_datepicker, init_delete_btns, init_details_display, init_sort, init_sort_btns, init_toggle_details_btn, low_els, on_ajax_error, set_details_btn_text, set_sort_btn_imgs, set_sort_state, sort_tasks_by, state, toggle_sort_dir, update_tasks;
  ...
  toggle_sort_dir = function(attr) {
    return state.sort.is_asc[attr] = !state.sort.is_asc[attr];
  };
  ...
  init_sort_btns = function() {
    ...
    return set_sort_btn_imgs(state.sort.column);
  };
