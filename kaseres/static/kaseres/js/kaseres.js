...
(function() {
  var bg_colors, click_add_btn, click_delete, click_sort_btn, click_toggle_details, delete_task, details_showing, high_els, highlight_col, init_add_btn, init_all, init_delete_btns, init_details_display, init_sort, init_sort_btns, init_toggle_details_btn, low_els, on_error, set_details_btn_text, sort_by, sort_by_attr, sort_column, unhighlight_col, unhighlight_task, update_tasks;
  ...
  click_add_btn = function() {
    return alert('Open form for creating task.');
  };
